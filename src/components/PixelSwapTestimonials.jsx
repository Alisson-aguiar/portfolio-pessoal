  ...
  const testimonials = [
    {
      id: 1,
      name: 'Marcos Almeida',
      role: 'Fundador, StyleEcom',
      quote: 'A nossa loja virtual precisava de uma renovação total. O Alisson desenvolveu um e-commerce rápido, seguro e muito fácil de navegar. Nossas vendas dobraram no primeiro mês após o lançamento!',
    ...
    },
    {
      ...
      quote: 'As landing pages que o Alisson criou para nossas campanhas têm uma taxa de conversão absurda. O design é impecável, focado em resultados, e o tempo de carregamento da página é quase instantâneo.',
    ...
    },
    {
      ...
      role: 'Sócio, Consultoria Global',
      quote: 'Nosso site institucional antigo não passava credibilidade. O Alisson capturou perfeitamente a essência da nossa empresa e construiu um site moderno e elegante que transmite total confiança aos clientes.',
