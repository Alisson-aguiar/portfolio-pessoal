...
const spiralImages = [
  ...
  { src: '/destaques/enegia-solar-notbook.jpg', alt: 'Energia Solar' },
  { src: '/destaques/evolution-php-desktop.jpg', alt: 'Evolution PHP' },
  { src: '/destaques/kanban-realtime-desktop.jpg', alt: 'Kanban Realtime' },
  { src: '/destaques/oxm-consultorias.jpg', alt: 'OXM Consultoria' },
  { src: '/destaques/saas-analytics-platform-desktop.jpg', alt: 'SaaS Analytics' }
];
...
export default function CTASection() {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      // Build WhatsApp URL
      const text = `Olá Alisson! Meu nome é ${formData.name}. Gostaria de solicitar um orçamento para ${formData.service}. Prazo: ${formData.date || 'a combinar'}. Mensagem: ${formData.message}`;
      const encoded = encodeURIComponent(text);
      window.open(`https://wa.me/558496572500?text=${encoded}`, '_blank');
                  ...
                  <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder="Conte um pouco sobre sua visão para o projeto..."
                        style={{
                          width: '100%',
                          padding: '14px 18px',
                          backgroundColor: 'rgba(255, 255, 255, 0.05)',
